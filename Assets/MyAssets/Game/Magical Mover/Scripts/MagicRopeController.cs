...
public class MagicRopeController : MonoBehaviour
{
    ...
    {
        if (!recognizeOutputs[0].recognizedGesture.gestureName.Equals(gestureName) || recognizeOutputs[0].probability > recognitionThreshold) return;
        if (object1!= null && object2 != null) { object1= null; object2 = null; lineRenderer.positionCount = 0; Destroy(joint); }
        if (object1 == null)
        {
